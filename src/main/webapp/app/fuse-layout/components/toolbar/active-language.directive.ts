...
@Directive({
    selector: '[jhiActiveLanguage]'
})
export class ActiveLanguageDirective implements OnInit {
    @Input() jhiActiveLanguage: string;
    ...
    updateActiveFlag(selectedLanguage) {
        if (this.jhiActiveLanguage === selectedLanguage) {
